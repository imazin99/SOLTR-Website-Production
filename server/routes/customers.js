...
const {
  customerLoginIp, customerLoginAccount, registrationIp, registrationAccount,
  forgotPasswordIp, forgotPasswordAccount, resetPasswordIp, verifyEmailIp,
  resendVerificationIp, resendVerificationAccount,
...
router.post('/register',     registrationIp, registrationAccount, register);
router.post('/login',        customerLoginIp, customerLoginAccount, login);
router.post('/logout',       requireCustomerAuth, logout);
router.post('/forgot-password', forgotPasswordIp, forgotPasswordAccount, forgotPassword);
router.post('/reset-password', resetPasswordIp, resetPassword);
router.post('/verify-email', verifyEmailIp, verifyEmail);
router.post('/resend-verification', resendVerificationIp, resendVerificationAccount, resendVerification);
