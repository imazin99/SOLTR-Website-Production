    ...
    <div class="pd-layout">
      <div class="pd-gallery">
        <div class="pd-main-img">
          <img id="pdMainImg" src="${esc(mainImg)}" alt="${esc(p.name)}" onerror="handleProductImageError(this)">
        ...
        <div class="pd-thumbs" id="pdThumbs">
          ${images.map((img, i) => `
            <button class="pd-thumb${i === 0 ? ' active' : ''}" data-src="${imgUrl(img)}">
              <img src="${esc(imgUrl(img))}" alt="" onerror="handleProductImageError(this)">
            </button>`).join('')}
        </div>` : ''}
      </div>
        ...
        <div class="card-media-frame">
          <a href="product.html?id=${r._id}" class="card-media-link">
            <div class="card-media">
              <img class="related-img img-a" src="${esc(img1)}" alt="${esc(r.name)}" loading="lazy" onerror="handleProductImageError(this)">
              <img class="related-img img-b" src="${esc(img2)}" alt="" loading="lazy" onerror="handleProductImageError(this)">
